  ...
  return (
    <div style={{ backgroundColor: `${navBg}` }} className={shadow ? 'w-full h-20 shadow-lg fixed z-[100]' : 'w-full h-20 fixed z-[100]'}>
      <div className='flex justify-between items-center w-full h-full px-24 2xl:px-16'>
        ...
        <div>
          ...
          <div className='flex md:hidden gap-6'>
            ...
            <div onClick={handleNav} className='rounded-full shadow-lg shadow-gray-400 p-2 cursor-pointer hover:scale-105 ease-in duration-300'>
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/50' : ''}>
        <div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-8 ease-in duration-500' : 'fixed left-[-100%] top-0 p-8 ease-in duration-500'}>
          <div>
            ...
            <div className='py-6 flex flex-col'>
              ...
              <div className='pt-40'>
                <p className='uppercase tracking-widest text-[#6fb632]'>Lets Connect</p>
